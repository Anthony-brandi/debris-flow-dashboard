...
function figPlaceholder(x, y, w, h, mainLabel, subLabel) {
  ...
  slide.addText(mainLabel, {
    ...
    align: "center", margin: 0, fontFace: "Gill Sans MT",
  });
  if (subLabel) {
...
function caption(x, y, w, text) {
  slide.addText(text, {
    x, y, w, h: 0.65,
    fontSize: 13, color: TEXT_LITE, italic: true,
    align: "left", margin: 0, wrap: true, fontFace: "Gill Sans MT",
  });
}
...
slide.addText("Post-Fire Watershed Risk Portal", {
  ...
  fontFace: "Gill Sans MT", align: "left", margin: 0,
});
slide.addText(
...
slide.addText(
  ...
  { x: LEFT_X+0.25, y: ly+0.72, w: LEFT_W-0.5, h: 7.1,
    fontSize: 16, color: TEXT_DARK, align: "left", valign: "top",
    margin: 0, wrap: true, fontFace: "Gill Sans MT" }
);
ly += 8.5;
...
slide.addText(
  ...
  { x: LEFT_X+0.25, y: ly+4.5, w: LEFT_W-0.5, h: 0.9,
    fontSize: 16, color: TEAL_ACC, bold: true, italic: true,
    align: "center", margin: 0, fontFace: "Gill Sans MT" }
);
slide.addText(
  ...
  { x: LEFT_X+0.25, y: ly+5.6, w: LEFT_W-0.5, h: 1.2,
    fontSize: 12.5, color: TEXT_MID, align: "left", margin: 0, wrap: true, fontFace: "Gill Sans MT" }
);
ly += 9.8;
...
fireData.forEach((fire, i) => {
  ...
  slide.addText(fire.name, {
    ...
    align: "left", margin: 0, fontFace: "Gill Sans MT",
  });
...
slide.addText(
  ...
  { x: CTR_X+0.25, y: sumY+0.1, w: CTR_W-0.5, h: 0.75,
    fontSize: 16, color: GREEN_DARK, bold: true,
    align: "center", margin: 0, fontFace: "Gill Sans MT" }
);
...
slide.addText("Why does Thomas over-predict at 24 mm/hr?", {
  ...
  align: "left", margin: 0, fontFace: "Gill Sans MT", wrap: true,
});
...
slide.addText("Key Takeaways", {
  ...
  fontFace: "Gill Sans MT", align: "left", margin: 0, charSpacing: 1,
});
...
takeaways.forEach((tk) => {
  ...
  slide.addText(
    ...
    { x: RIGHT_X+0.35, y: tkY, w: RIGHT_W-0.55, h: 2.2,
      fontSize: 13, align: "left", margin: 0, wrap: true, fontFace: "Gill Sans MT" }
  );
  tkY += 2.35;
});
...
slide.addText(
  ...
  { x: 0.4, y: 35.66, w: 47, h: 0.3,
    fontSize: 9, color: "A8D5BE", align: "left", margin: 0, fontFace: "Gill Sans MT" }
);
